...
const AlertMessage = ({ userName, userImage, contenido, chatId }) => {
  return (
    ...
    <Link className="w-full" href={`${appRoutes.messages()}#chatId${chatId}`}>
      <div className="w-full cursor-pointer gap-2 w-full appearsMessage h-[80px] p-4 bg-gray-200 rounded-lg shadow-md flex flex-row items-center justify-start">
