...
export default function CardDashboardItem ({title, data, clickable = true}) {
    return (
    <div className={clsx("w-auto h-auto overflow-hidden flex flex-col items-start justify-center gap-y-4 rounded-[9px] shadow-xl bg-[#242424]", clickable && "cursor-pointer transition-all transform hover:scale-110 hover:bg-opacity-50")}>
