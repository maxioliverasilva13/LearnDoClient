    ...
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={setIsOpen}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-black-800/200 backdrop-blur-md transition-opacity" />
        </Transition.Child>
        ...
        <div className="fixed inset-0 z-20 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-[#2A2B36] px-4 pb-4 text-left shadow-xl transition-all mt-2 sm:w-[90%] sm:max-w-2xl sm:p-6">
