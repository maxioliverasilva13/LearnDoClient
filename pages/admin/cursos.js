      ...
      <main className="miscursos_page lg:px-10 px-5 py-10 w-full h-full flex flex-col gap-4 items-center min-h-screen">
        ...
        <div className="w-full flex md:px-36 md:justify-start justify-center gap-5 ml-20">
          <Link href={appRoutes.createCurso()}>
            <span className="bgPrincipal shadow-md cursor-pointer transition-all transform hover:scale-105 my-2 px-6 py-2 w-max text-xl text-white block rounded-full ">
              Crear Curso
            </span>
          </Link>
          <Link href={appRoutes.createSeminario()}>
            <span className="bgPrincipal shadow-md cursor-pointer transition-all transform hover:scale-110 my-2 px-6 py-2 w-max text-xl text-white block rounded-full ">
              Crear Seminario
            </span>
          </Link>
        </div>
